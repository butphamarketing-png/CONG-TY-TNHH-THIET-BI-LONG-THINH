        ...
        <div className="container mx-auto px-4 flex justify-between items-center">
          <div className="flex items-center gap-5">
            <a href="tel:0123456789" className="flex items-center gap-1.5 hover:text-white transition-colors">
              ...
              <span>Hotline: <strong className="text-white">1800.xxxx</strong> (Miễn phí)</span>
            </a>
      ...
      <header className="bg-white border-b border-border sticky top-0 z-50 shadow-sm">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3 md:gap-6">
          ...
          <div className="flex items-center gap-1 ml-auto md:ml-0">
            ...
            {/* Wishlist */}
            <Link href="#" className="hidden md:flex items-center gap-1.5 px-3 py-2 text-sm hover:text-primary transition-colors">
              <Heart className="w-5 h-5" />
              <span className="hidden lg:block">Yêu thích</span>
            </Link>

            {/* Hotline */}
            <a href="tel:1800xxxx" className="hidden lg:flex items-center gap-2 px-3 py-2 text-sm border-l border-border">
              <Phone className="w-5 h-5 text-primary" />
              <div className="leading-tight">
                <div className="text-[10px] text-muted-foreground">Hotline</div>
                <div className="font-bold text-sm">1800.xxxx</div>
              </div>
            </a>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
            ...
            <div>
              ...
              <p className="text-sm mb-5 leading-relaxed text-slate-400">
                Hệ thống bán lẻ điện thoại, laptop, máy tính bảng và phụ kiện chính hãng uy tín nhất Việt Nam.
              </p>
              <div className="space-y-2 text-sm text-slate-400">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>1800.xxxx (Miễn phí - 8h-22h)</span>
                </div>
                <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="bg-slate-800 hover:bg-slate-700 transition-colors p-4 rounded-lg">
                  ...
                  <a href="tel:1800xxxx" className="text-xl font-bold text-white hover:text-primary transition-colors">1800.xxxx</a>
                </div>
                <div className="bg-slate-800 hover:bg-slate-700 transition-colors p-4 rounded-lg">
                  <div className="text-xs text-slate-400 mb-1">Bảo hành & Khiếu nại</div>
                  <a href="tel:1800yyyy" className="text-xl font-bold text-white hover:text-primary transition-colors">1800.yyyy</a>
                </div>
          ...
          <div className="border-t border-slate-800 pt-6 flex flex-col md:flex-row justify-between items-center gap-3">
            <p className="text-xs text-slate-500">
              © {new Date().getFullYear()} TDM Shop. GPKD số: 0312345678 do Sở KH&ĐT TP.HCM cấp.
            </p>
